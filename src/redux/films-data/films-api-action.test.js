...
import { SET_FAVORITE_FILMS, SET_LOADED_FILMS, SET_LOADED_REVIEWS, SET_PROMO_FILM, SET_REVIEW_IS_SENDING, SET_SELECTED_FILM } from './films-action-type';
import { addFavorite, fetchFavoriteFilms, fetchFilmsList, fetchPromoFilm, fetchReviewsFilm, fetchSelectedFilm, sendingReview } from './films-api-action';
...
describe('Async operation', () => {
  ...
  it('should make a correct API call to POST /favorite/:id/status', () => {
    ...
    const favoriteLoader = addFavorite(fakeReplyTrue.id, fakeReplyTrue.isFavorite ? '1' : '0');
